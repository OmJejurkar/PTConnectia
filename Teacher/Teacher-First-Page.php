...
<body>
    <div class="tfp-div">
        ...
        <button class="big-button" onclick="window.location.href='Teacher-Student-Achivement.php'">Add Achievement</button>
    ...
    <div class="in">
        ...
        <label class="half-label"><?php echo $username; ?></label>
        <label class="half-label">Post: <?php echo $post; ?></label>
        <div class="footer">  
            <button class="small-button" onclick="window.location.href='edit.php'">Edit</button>
